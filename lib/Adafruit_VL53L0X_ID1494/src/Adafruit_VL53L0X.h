...
{
  public:
    boolean       begin(int mode = VL53L0X_GOOD_ACCURACY_MODE, uint8_t i2c_addr = VL53L0X_I2C_ADDR, boolean debug = false, TwoWire *i2c = &Wire);
    ...
    */
    ...
    VL53L0X_Error 
      rangingTest(VL53L0X_RangingMeasurementData_t* pRangingMeasurementData, 
		  boolean debug = false) 
    { return getRangingMeasurement(pRangingMeasurementData, debug); };
    ...
    VL53L0X_Error getRangingMeasurement( VL53L0X_RangingMeasurementData_t *RangingMeasurementData, boolean debug = false );
