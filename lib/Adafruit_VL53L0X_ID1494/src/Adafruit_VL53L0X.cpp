...
*/
/**************************************************************************/
boolean Adafruit_VL53L0X::begin(int mode, uint8_t i2c_addr, boolean debug, TwoWire *i2c) {
  int32_t   status_int;
  int32_t   init_done         = 0;
  ...
  switch(mode) {
      case VL53L0X_BEST_ACCURACY_MODE:
        Serial.println(F ("VL53L0X_BEST_ACCURACY_MODE"));
        if( Status == VL53L0X_ERROR_NONE ) {
            if( debug ) {
                Serial.println( F( "VL53L0X: SetLimitCheckValue SIGNAL_RATE_FINAL_RANGE" ) );
            }
        ...
        if( Status == VL53L0X_ERROR_NONE ) {
            if( debug ) {
                Serial.println( F( "VL53L0X: SetLimitCheckValue SIGMA_FINAL_RANGE" ) );
            }
        ...
        if( Status == VL53L0X_ERROR_NONE ) {
            if( debug ) {
                Serial.println( F( "VL53L0X: SetMeasurementTimingBudgetMicroSeconds" ) );
            }
            Status = VL53L0X_SetMeasurementTimingBudgetMicroSeconds( pMyDevice, 200000 );
        }
        break;
    case VL53L0X_LONG_RANGE_MODE:
        Serial.println(F ("VL53L0X_LONG_RANGE_MODE"));
        if( Status == VL53L0X_ERROR_NONE ) {
            if( debug ) {
                Serial.println( F( "VL53L0X: SetLimitCheckValue SIGNAL_RATE_FINAL_RANGE" ) );
            }
        ...
        if( Status == VL53L0X_ERROR_NONE ) {
            if( debug ) {
                Serial.println( F( "VL53L0X: SetVcselPulsePeriod PRE_RANGE" ) );
            }
    ...
    case VL53L0X_BETTER_ACCURACY_MODE:
        Serial.println(F ("VL53L0X_BETTER_ACCURACY_MODE"));
        if( Status == VL53L0X_ERROR_NONE ) {
            if( debug ) {
                Serial.println( F( "VL53L0X: SetMeasurementTimingBudgetMicroSeconds" ) );
            }
            Status = VL53L0X_SetMeasurementTimingBudgetMicroSeconds( pMyDevice, 66000 );
        }
        break;
    case VL53L0X_GOOD_ACCURACY_MODE:
    default:
        Serial.println(F ("VL53L0X_GOOD_ACCURACY_MODE"));
        if( Status == VL53L0X_ERROR_NONE ) {
            if( debug ) {
                Serial.println( F( "VL53L0X: SetMeasurementTimingBudgetMicroSeconds" ) );
            }
 ...
 if( Status == VL53L0X_ERROR_NONE ) {
    if( debug ) {
        Serial.println( F( "VL53L0X: StartMeasurement" ) );
    }
...
VL53L0X_Error Adafruit_VL53L0X::getRangingMeasurement(VL53L0X_RangingMeasurementData_t *RangingMeasurementData, boolean debug)
{
    ...
    if( Status == VL53L0X_ERROR_NONE ) {
        if( debug ) {
            Serial.println( F( "VL53L0X: WaitMeasurementDataReady" ) );
        }
    ...
    if( Status == VL53L0X_ERROR_NONE ) {
        ...
        if( debug ) {
            Serial.println( F( "VL53L0X: GetRangingMeasurementData" ) );
        }
    ...
    if( Status == VL53L0X_ERROR_NONE ) {
        if( debug ) {
            Serial.println( F( "VL53L0X: Clear the interrupt" ) );
        }
        // Clear the interrupt
